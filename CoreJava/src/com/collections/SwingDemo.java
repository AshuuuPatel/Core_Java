	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==b1) {
			try {
				...
				Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/java_8_new","root","");
				String sql="inserrt into student(fname,lname,email,mobile) values(?,?,?,?)";
